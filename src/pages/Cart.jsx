    ...
    <div className="mx-auto p-4 h-[100dvh] md:h-[70dvh] sm:flex-row justify-center mt-10 flex flex-col gap-6">
      ...
      <div className="bg-white p-6 h-fit shadow-lg rounded-lg ">
        ...
        <button
          ...
          className="mt-4 w-full whitespace-nowrap disabled:bg-slate-6c00 disabled:cursor-not-allowed bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition"
        >
          Proceed to Checkout
        </button>
      </div>
